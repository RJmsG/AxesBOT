...
prefix = 'Hey,'
commands = [
  'newmeme', 'meme', 'inform', 'say', 'spam', 'world-status', 'save', 'run','wait','vote','votes','why','tip']
tips = [
  'Bored? Try the new "meme" command!',
  'Are you a nerd looking for the bots specs? Try the "inform" command!',
  'Need help? Try the-',
...
file.close()
file = open('users', 'r')
ulist = ''.join(file.readlines()).split('\n')
file.close()
file = open('votes', 'r')
